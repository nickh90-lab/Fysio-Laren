    ...
    return (
        <section className="py-24 md:py-32 px-6 md:px-12 flex flex-col items-center relative overflow-hidden bg-background">
            <div className="max-w-7xl w-full relative z-10">
                ...
                {/* The Balloon View (Optie 2: Ultra Light Sand & White) */}
                <div className="flex flex-wrap justify-center items-center gap-6 md:gap-x-12 md:gap-y-10 max-w-7xl mx-auto relative z-0 pt-4 pb-16 px-4">
                    {balloonClusters.map((cluster, idx) => {
                        ...
                        return (
                            <div
                                key={cluster.id}
                                className={`relative flex flex-col items-center justify-center text-center p-4 rounded-full text-black shadow-sm hover:shadow-xl border border-slate-100 transition-all duration-300 cursor-default w-[220px] h-[220px] md:w-[280px] md:h-[280px] hover:scale-105 overflow-hidden ${bgStyleClass} ${
