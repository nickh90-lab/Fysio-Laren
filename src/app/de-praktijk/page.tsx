                ...
                <div className="bg-transparent">
                    ...
                    <div className="flex flex-col gap-16 md:gap-20">
                        ...
                        <div className="bg-white rounded-[3rem] p-8 md:p-12 shadow-sm border border-foreground/5 flex flex-col md:flex-row items-center gap-12 lg:gap-20">
                            <div className="w-full md:w-1/2 relative aspect-square rounded-[2rem] overflow-hidden shadow-lg border border-foreground/5">
                                <Image src="/images/pand-huenderstraat.jpg" alt="Pand Huenderstraat Fysio Laren" fill className="object-cover" />
                            </div>
                        ...
                        {/* Block 2: Interior */}
                        <div className="bg-white rounded-[3rem] p-8 md:p-14 shadow-sm border border-foreground/5 text-center">
                            <div className="max-w-3xl mx-auto">
                                <h2 className="text-3xl md:text-4xl font-bold mb-6 text-foreground">Praktijk en oefenruimte</h2>
                                <p className="text-foreground/70 text-lg md:text-xl leading-relaxed mb-10 font-light">
                                ...
                                <ul className="flex flex-col sm:flex-row flex-wrap justify-center items-center gap-4 sm:gap-8 pt-2">
                                    <li className="flex items-center gap-2.5 text-foreground/80 font-medium">
                                        <CheckCircle2 className="text-blue-accent w-5 h-5 flex-shrink-0" />
                                        <span>Fijne behandelkamers</span>
                                    </li>
                                    <li className="flex items-center gap-2.5 text-foreground/80 font-medium">
                                        <CheckCircle2 className="text-blue-accent w-5 h-5 flex-shrink-0" />
                                        <span>Oefenzaal</span>
                                    ...
                                    <li className="flex items-center gap-2.5 text-foreground/80 font-medium">
                                        <CheckCircle2 className="text-blue-accent w-5 h-5 flex-shrink-0" />
                                        <span>Behandeling en oefentherapie onder 1 dak</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
