    ...
    <div className="pt-20">
      ...
      <div className="w-full bg-background flex flex-col lg:flex-row min-h-[85vh] -mt-20 pt-32 pb-16 relative">
        <div className="max-w-screen-2xl mx-auto w-full flex flex-col lg:flex-row items-center px-6 lg:px-12 xl:px-24 gap-12 lg:gap-24">
          ...
          <div className="w-full lg:w-1/2 relative h-[55vh] sm:h-[65vh] lg:h-auto min-h-[420px] sm:min-h-[560px]">
            <div className="absolute inset-0 lg:inset-y-8 right-0 rounded-[2.5rem] overflow-hidden shadow-[0_30px_70px_-15px_rgba(30,41,59,0.15)] border-[3px] border-white/80">
              <Image src={heroImageSrc} alt="Fysiotherapie praktijk Laren" fill className="object-cover object-center" priority />
            </div>
          </div>
        </div>
      </div>
